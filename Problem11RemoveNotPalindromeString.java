...
public class Problem11RemoveNotPalindromeString {
	static String str[]= {"madam","ssad","akscfd"};
	
	public static void main(String[] args) {
		Problem11RemoveNotPalindromeString t= new Problem11RemoveNotPalindromeString();
